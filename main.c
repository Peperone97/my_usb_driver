...
void transfer( struct libusb_device_handle *device_handle ){
	uint8_t msg[] = {  0x00, 0x1f, 0x00, 0x00, 0x00, 0x08, 0x0f, 0x03, 0x00, 0x00, 0x00, 0x00,
	...
	int err = libusb_interrupt_transfer( device_handle, 0x00, msg, sizeof(msg), &read, 8000 );
	if( err != 0 ){
